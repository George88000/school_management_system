...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('employees')->group(function () {
        ...
        // End Employee Registration Routes
        ...
        // End Employee Attendance Routes
